...
def plot_reg_multiple(
    xvals, yvals, polys, x_label="x", y_label="y", data_labels=None, reg_labels=None, fname=None
) -> None:
    """TODO."""
    import matplotlib.pyplot as plt
...
def mfhurst_b(
    data, qvals=None, dists=None, fit="poly", debug_plot=False, debug_data=False, plot_file=None
):
    ...
    polys = [poly_fit(xvals, yvals[:, qi], 1, fit=fit) for qi in range(len(qvals))]
